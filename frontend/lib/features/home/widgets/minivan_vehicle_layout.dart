...
class MinivanSeatWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isSelected) {
      ...
      // Available (matching user reference: silver/grey top cushion + dark navy/slate cradle)
      ...
      child: AnimatedScale(
        ...
        child: SizedBox(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              // Exact Minivan Chair Silhouette
              SizedBox(
                width: 42,
                height: 42,
                child: Stack(
                  ...
                  children: [
                    ...
                    // Lower U-Shaped Cradle Bolster & Armrests wrapping around the seat
                    Positioned(
                      bottom: 2,
                      child: Container(
                        width: 38,
              ...
              // Seat Label Text directly below the chair (e.g. A1, A2, A3)
              Text(
                seatLabel,
                style: GoogleFonts.dmSans(
                  fontSize: 13,
